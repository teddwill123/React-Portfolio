    ...
    return (
        <div name='contact' className='w-full h-screen bg-[#111010] flex justify-center items-center p-4'>
            <form method='POST' action="https://getform.io/f/pbnvlmjb" className='flex flex-col max-w-[600px] w-full'>
                <div className='pb-8'>
                    <p className='text-4xl font-bold inline border-b-4 border-[#38BDF8] text-gray-300'>Contact</p>
                ...
                <button className='text-white border-2 hover:bg-[#38BDF8] hover:border-[#38BDF8] px-4 py-3 my-8 mx-auto items-center'>Let's collaborate</button>
            </form>
        </div>
    )
}
