  ...
  return (
    <div className="fixed w-full h-[100px] flex justify-between items-center px-4 bg-[#111010] text-gray-50">
      <div>
        ...
        <h1 className='text-[#38BDF8] text-4xl font-bold cursor-pointer'>TEDDY</h1>
      </div>
        ...
        <ul>
          <li className="w-[160px] h-[60px] flex justify-center items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600">
            <a
              ...
              href="https://www.linkedin.com/in/teddy-f-willie-7b8626264"
            >
              Linkedin
              <FaLinkedin size={30} />
            </a>
          ...
          <li className="w-[160px] h-[60px] flex justify-center items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333333]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="https://github.com/teddwill123"
            >
              GitHub
              <FaGithub size={30} />
            </a>
          </li>
          <li className="w-[160px] h-[60px] flex justify-center items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#637A9F]">
            <a
              className="flex justify-between items-center w-full text-gray-300"
              href="mailto:teddywilliejr@gmail.com"
            >
              Email
              <FaEnvelope size={30} />
            </a>
